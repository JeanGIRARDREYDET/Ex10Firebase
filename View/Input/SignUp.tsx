...
import {UserCreate} from "../../Component/Auth/UserCRU"
    ...
    const onSubmit = () => {
        ...
        if (errors.email == undefined && errors.password == undefined && errors.passwordConfirmation == undefined) {
            ...
            if (password !== passwordConfirmation) {
                ...
                const UserAuth : { Uid: string, errors: string } = UserCreate(email, password);
    ...
    return (
        <View style={styles.container}>
            <ScrollView>
                ...
                <Button onPress={() => onSubmit()} title="Sign me up" type="primary" />
            </ScrollView>
        </View>
    )
}
